    ...
    <div className={styles.container}>
      ...
      {/* <div className={styles.contentContainer1}>
        ...
        <div className={styles.subSections2}>
          ...
          <div className={styles.wireframes}>
            ...
            <img src={resolveAsset(ZOOXW3)} alt="ZOOX Home page wireframe" />
            <img src={resolveAsset(ZOOXW4)} alt="ZOOX Home page wireframe" />
      ...
      <div>
        ...
        >
          <img
            style={{ width: "35%" }}
            src={resolveAsset(InitialIdelDisplay)}
            alt="Initial Idle Display After"
          />
          <div style={{ padding: "30px" }}>➡</div>
          <img
            style={{ width: "35%" }}
            src={resolveAsset(InitialIdleDisplayAfter)}
            alt="Initial Idle Display After"
          />
        </div>
        <div
        ...
        >
          <img style={{ width: "35%" }} src={resolveAsset(Home)} alt="Home" />
          <div style={{ padding: "30px" }}>➡</div>
          <img style={{ width: "35%" }} src={resolveAsset(HomeAfter)} alt="Home After" />
        </div>
      </div>
    </div>
  );
